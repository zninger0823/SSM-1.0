...
public class ProductServiceImp implements ProductService{
	...
	//3.结合productId批量处理商品详情图：在mapper中设置useGeneratedKeys="true"可传递ID
	//4.将商品详情图列表批量插入tb_prodcut_img中
	...
	@Transactional
	//1.若缩略图参数有值，则处理缩略图
	//若已存在缩略图则先将其删除再添加新图，之后获取缩略图相对路径并赋值给product
